...
| [XFINLAB](https://www.xfinlab.com/intelligence-api.html) | 金融市场情报 API：市场事件、新闻情绪分析、技术指标、宏观经济数据（FRED 等），可通过远程 MCP 直接调用。 | 官方实现，Python 开发 🐍，云服务 ☁️，X-API-Key 鉴权，免费额度即时申请。 |
